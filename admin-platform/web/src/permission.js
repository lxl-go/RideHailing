...
import { resolveDefaultRouteName } from '@/utils/defaultRoute'
  ...
  if (WHITE_LIST.includes(to.name)) {
    if (token) {
      ...
      if(userStore.userInfo.authority.defaultRouter){
        return { name: resolveDefaultRouteName(userStore.userInfo.authority.defaultRouter, router.hasRoute.bind(router)) }
      }
    }
    return  true
  }
