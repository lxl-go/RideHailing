...
#userLayout {
  background:
    radial-gradient(circle at top right, rgba(34, 100, 242, 0.08), transparent 30%),
    radial-gradient(circle at bottom left, rgba(7, 193, 96, 0.06), transparent 26%),
    var(--gva-main-bg);
}
...
.gva-body-h {
  min-height: calc(100vh - 64px - 16px - 24px);
}
</style>
